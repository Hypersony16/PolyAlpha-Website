...
def health_payload() -> dict:
    ...
    return {
        ...
        "db_size_bytes": db_size, "smtp_ready": smtp_ready(),
...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if path in ("/", "/home", "/terminal", "/dashboard", "/signals", "/wallets", "/feed", "/flow", "/watchlist", "/backtest", "/analytics", "/history", "/compare", "/portfolio", "/settings", "/notifications", "/alerts", "/quality"):
