...
from bot.web_alerts import process_web_telegram_alerts


logging.basicConfig(level=logging.INFO)


async def web_telegram_alerts_job(context):
    try:
        process_web_telegram_alerts()
    except Exception:
        logging.exception("Web Telegram alert worker failed")
...
def main():
    ...
    if app.job_queue is not None:
        ...
        app.job_queue.run_repeating(web_telegram_alerts_job, interval=60, first=30)
