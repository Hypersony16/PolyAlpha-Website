...
from bot.web_alerts import process_web_email_alerts


logging.basicConfig(level=logging.INFO)


async def web_email_alerts_job(context):
    try:
        process_web_email_alerts()
    except Exception:
        logging.exception("Web email alert worker failed")
...
def main():
    ...
    if app.job_queue is not None:
        ...
        app.job_queue.run_repeating(web_email_alerts_job, interval=60, first=30)
